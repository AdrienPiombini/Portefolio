...
<?php 
    ...
    <nav class="navigationbar">
        ...
        <a href="index.php?page=1">Mon Profil</a>
        <a href="index.php?page=2">Mes projets</a>
        <a href="index.php?page=3">Veille</a>
        <a href="index.php?page=4">Contact</a>
        <hr>
    </nav>
    <div class="content">
    ';
        ...
        switch ($page){
            ...
            case 1: require_once('profil.php'); break;
            case 2: require_once('projet.php'); break;
            case 3: require_once('veille.php'); break;
...
<div><a href="">© 2022 PIOMBINI Adrien • All Rights Reserved</a></div>
</footer>
</body>
